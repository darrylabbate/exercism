...
static void test_b0_is_decimal_0(void)
{
   TEST_ASSERT_EQUAL(0, convert("0"));
}

static void test_b1_is_decimal_1(void)
{
   TEST_ASSERT_EQUAL(1, convert("1"));
}

static void test_b10_is_decimal_2(void)
{
   TEST_ASSERT_EQUAL(2, convert("10"));
}

static void test_b11_is_decimal_3(void)
{
   TEST_ASSERT_EQUAL(3, convert("11"));
}

static void test_b100_is_decimal_4(void)
{
   TEST_ASSERT_EQUAL(4, convert("100"));
}

static void test_b1001_is_decimal_9(void)
{
   TEST_ASSERT_EQUAL(9, convert("1001"));
}

static void test_b10001101000_is_decimal_1128(void)
{
   TEST_ASSERT_EQUAL(1128, convert("10001101000"));
}

static void test_b11010_is_decimal_26(void)
{
...
static void test_a_number_and_a_word_whitespace_spearated_is_invalid(void)
{
