...
void test_duplicated_letter_and_non_letter_char(void)
{
   TEST_ASSERT_FALSE(is_isogram("Hjelmqvist-Gryb-Zozk-Pfund-Wax"));
}
...
int main(void)
{
   ...
   RUN_TEST(test_duplicated_letter_and_non_letter_char);
